...
```{r}
data <- load_data("data/demo_5Ags.csv", sep=';')
head(data)
tail(data)
```
...
```{r}
distribution <- markers_distribution(data_long, case_class = 'A', y_lim = 0.0015, x_lim = 3000, signalthr_prediction = TRUE, min_SE = 40, min_SP = 80)
