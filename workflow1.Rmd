...
combithr should be set exclusively depending on the needed stringency. In this example the obtained combinations dataframe is assigned to "*tab*" objects.
...
**show_markers()** returns the composition of the combination of interest. It requires as input one or more combinations and the table containing  the marker combinations and counts their corresponding positive samples for each class (*"tab"*, obtained by Combi()).
```{r}
...
**combs_with()** returns the combinations containing all the markers of interest. It requires as input one or more marker and the table containing  the marker combinations and counts their corresponding positive samples for each class (*"tab"*, obtained by Combi()).
```{r}
