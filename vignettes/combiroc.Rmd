...
ggplot(mks, aes(x = `SP%_B`, y = `SE%_A`, size = `#Markers` )) +
...
If the user wants to highlight the "Golden" combinations (how they were called in the CombiROC web-app), i.e. those above choosen thresholds of SE and SP, first the user need to set the custom cutoffs to 
